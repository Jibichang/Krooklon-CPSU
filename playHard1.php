      ...
      <div class="row-about">
        ...
        <div class="col-about-game">
          <form action="#" method="post" onsubmit="return confirm('คุณแน่ใจที่จะส่งกลอนแล้วใช่มั้ย?');">
            <input type=text id="textBoxKlon" name="klon1" onkeyup="Hard1()"><br>
            <input type=text id="textBoxKlon2" name="klon2" onkeyup="Hard1()"><br>
            <input type=text id="textBoxKlon3" name="klon3" onkeyup="Hard1()"><br>
            <input type=text id="textBoxKlon4" name="klon4" onkeyup="Hard1()"><br>
